      ...
      <div style={s.navSection}>
        {isDoctor ? (
          ...
          <>
            ...
            {nav.filter(n=>['dashboard','patients'].includes(n.id)).map(item => <NavItem key={item.id} item={item} active={current===item.id} onClick={()=>onChange(item.id)} count={counts[item.badge]} />)}
